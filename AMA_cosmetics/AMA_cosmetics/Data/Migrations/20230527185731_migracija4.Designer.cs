...
namespace AMA_cosmetics.Data.Migrations
{
    ...
    [Migration("20230527185731_migracija4")]
            ...
            modelBuilder.Entity("AMA_cosmetics.Models.DodeljeniPopusti", b =>
                {
                    ...
                    b.Property<int?>("PremiumKorisikID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AMA_cosmetics.Models.DodeljeniPopusti", b =>
                {
                    ...
                    b.HasOne("AMA_cosmetics.Models.PremiumKorisnik", "PremiumKorisik")
                        .WithMany()
                        .HasForeignKey("PremiumKorisikID");

                    b.Navigation("Popust");

                    b.Navigation("PremiumKorisik");
                });
