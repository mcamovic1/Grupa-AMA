...
namespace AMA_cosmetics.Data.Migrations
{
    ...
    [Migration("20230527185148_migracija3")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AMA_cosmetics.Models.DodeljeniPopusti", b =>
                {
                    ...
                    b.Property<int?>("PopustiID")
                        .HasColumnType("int");

                    b.HasKey("ID");

                    b.HasIndex("KorisikID");

                    b.HasIndex("PopustiID");
            ...
            modelBuilder.Entity("AMA_cosmetics.Models.DodeljeniPopusti", b =>
                {
                    b.HasOne("AMA_cosmetics.Models.PremiumKorisnik", "Korisik")
                        .WithMany()
                        .HasForeignKey("KorisikID");

                    b.HasOne("AMA_cosmetics.Models.Popust", "Popusti")
                        .WithMany()
                        .HasForeignKey("PopustiID");

                    b.Navigation("Korisik");

                    b.Navigation("Popusti");
                });
